...
// toate cele 10 întrebări × 5 răspunsuri
const questionsData = [
    {q:"Cum îți petreci de obicei weekendurile?",a:[
    ...
    {q:"Ce e important pentru tine într-o locuință?",a:[
    ...
    {q:"Ce stil ți se potrivește cel mai mult?",a:[
    ...
    {q:"Ce te deranjează cel mai mult?",a:[
    ...
    {q:"Unde ți-ar plăcea cel mai mult să locuiești?",a:[
    ...
    {q:"Munca ta necesită mai mult:",a:[
    ...
    {q:"Cum te raportezi la vecini?",a:[
    ...
    {q:"Casa ta de vis trebuie să aibă:",a:[
    ...
    {q:"Care e scopul tău principal în viață?",a:[
...
// MAP: fiecare întrebare -> fiecare opțiune 0..4 -> profil
const MAP = [
...
async function onSubmit(e){
    ...
    // Redirect direct la LemonSqueezy LIVE
